...
async def create_log(request: Request, request_body: schemas.RequestBody):
	...
	response_data = schemas.ResponseData(headers={}, status_code=0)
	log = schemas.Log(origin='frontend', client=client_data, request=request_data, response=response_data)
